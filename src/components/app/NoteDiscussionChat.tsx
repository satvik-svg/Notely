    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-card overflow-hidden">
      ...
      <div className="px-5 py-3 border-t border-slate-50 flex gap-2">
        <input
          ...
          className="flex-1 text-xs font-body bg-slate-50 rounded-xl px-3 py-2.5 border 
                     border-slate-100 outline-none focus:border-brand-300 focus:ring-1 
                     focus:ring-brand-100 placeholder:text-slate-400"
        />
        <button
          onClick={sendComment}
          className="w-8 h-8 bg-brand-500 rounded-xl flex items-center justify-center 
                     hover:bg-brand-600 transition-colors shrink-0 self-end"
        >
