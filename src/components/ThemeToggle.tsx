...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full w-10 h-10 bg-secondary/50 hover:bg-secondary flex items-center justify-center transition-colors shadow-sm dark:shadow-none ring-1 ring-border"
    >
