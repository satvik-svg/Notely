...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full w-10 h-10 bg-surface-secondary/50 hover:bg-surface-secondary flex items-center justify-center transition-colors shadow-sm ring-1 ring-slate-200/50 dark:ring-slate-800/50 dark:bg-slate-800/50 dark:hover:bg-slate-800"
    >
