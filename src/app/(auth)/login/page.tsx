    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-6 pt-24">
        <div className="bg-card p-8 rounded-3xl shadow-float-md w-full max-w-md border border-border">
          <h1 className="font-display font-bold text-3xl text-foreground mb-2 text-center">Welcome back</h1>
          <p className="font-body text-muted-foreground mb-8 text-center text-sm">Sign in to your account</p>
