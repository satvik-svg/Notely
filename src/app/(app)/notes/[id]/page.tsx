      ...
      <div className="lg:col-span-2 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-card p-6 dark:bg-slate-900 dark:border-slate-800">
          <div className="flex justify-between items-start mb-4">
            <div>
              <span className="text-xs font-body text-slate-400 uppercase tracking-wider block mb-1 dark:text-slate-500">
                {note.subject}
              </span>
              <h1 className="font-display font-bold text-2xl text-slate-900 dark:text-slate-100">{note.title}</h1>
            </div>
          </div>

          <div className="flex items-center gap-4 text-xs font-body text-slate-400 dark:text-slate-500">
        ...
        {/* PDF viewer */}
        <div className="bg-white rounded-2xl border border-slate-100 shadow-card overflow-hidden dark:bg-slate-900 dark:border-slate-800" style={{ height: 600 }}>
          <iframe
            src={note.fileUrl}
      ...
      <div className="space-y-5">
        ...
        {firstChunkId && (
          <div className="bg-white rounded-2xl border border-slate-100 shadow-card p-5 dark:bg-slate-900 dark:border-slate-800">
            ...
            <p className="text-xs font-body text-slate-400 mb-3 dark:text-slate-500">
